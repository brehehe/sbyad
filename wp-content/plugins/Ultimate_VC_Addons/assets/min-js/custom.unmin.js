!function (a) {
	...
	a.fn.vc_translate_row = function () {
		...
		a(this).each(function (d, e) {
			...
			if (f = "undefined" == typeof f ? "false" : f.toString(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
				var g = "true";
			else
				var g = "false";
			if ("true" == g && "true" == f)
	...
	function a() {
		jQuery(".ultimate-map-wrapper").each(function (a, b) {
			...
			if ("full" == e && (g = jQuery("body"), f = "false"), "ex-full" == e && (g = jQuery("html"), f = "false"), !isNaN(e))
				for (var a = 0; a < e && "HTML" != g.prop("tagName"); a++)
					g = g.parent();
			if (0 == e || "0" == e)
				var h = g.width();
			else
